...
#define STRING_CONFIG_H_AUTHOR "(Kris D, Ender-3)" // Who made the changes. Customized DBP
...
#define CUSTOM_MACHINE_NAME "Kris' Ender 3" //Customized DBP
...
#define MANUAL_Y_HOME_POS -8 //kd tweaked
